                ...
                <div class="p-6 text-gray-900">
                    <form method="POST" action="{{ route('address-books.store') }}">
                        ...
                        <div class="mb-4">
                            ...
                            <x-text-input id="address_line" class="block mt-1 w-full" type="text" name="address_line" :value="old('address_line')" placeholder="Street address, building, apartment, etc." required />
                        ...
                        <div class="mb-6">
                            <label class="flex items-center">
                                <input type="checkbox" name="is_default" value="1" {{ old('is_default') ? 'checked' : '' }} class="rounded border-gray-300 text-blue-600 shadow-sm focus:ring-blue-500">
