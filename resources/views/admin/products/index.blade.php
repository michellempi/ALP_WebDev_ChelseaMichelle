                        ...
                        <tbody class="text-gray-700">
                            @foreach($products as $product)
                                <tr>
                                    ...
                                    <td class="w-1/6 text-left py-3 px-4">{{ $product->category->name }}</td>
                                    <td class="w-1/6 text-left py-3 px-4">{{ $product->stock_quantity }}</td>
                                    ...
                                    <td class="w-1/6 text-left py-3 px-4">{{ $product->created_at->format('Y-m-d') }}</td>
                                    <td class="text-left py-3 px-4">
                                        <a href="{{ route('admin.products.show', $product) }}" class="text-blue-500 hover:text-blue-700 mr-2">View</a>
